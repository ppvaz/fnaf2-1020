...
CAPTURE_SCREENRECORD_SIZE="${CAPTURE_SCREENRECORD_SIZE:-1280x576}"
case "$CAPTURE_SCREENRECORD_SIZE" in
  *[!0-9x]*|x*|*x|*x*x*) echo "CAPTURE_SCREENRECORD_SIZE must be WIDTHxHEIGHT" >&2; exit 2 ;;
esac
...
echo "Perfetto input trace running (pid $TRACE_PID, max ${TRACE_SECONDS}s; ${PERFETTO_CATEGORY_TEXT})"
