...
TAP_CONTACT_OVERRIDE_MS="${TAP_CONTACT_OVERRIDE_MS:-}"
...
[ -z "$TAP_CONTACT_OVERRIDE_MS" ] || recipe_args="$recipe_args --tap-contact-ms=$TAP_CONTACT_OVERRIDE_MS"
...
fnaf_session_begin "$OUT" "tools/device/legacy-trial.sh"
