...
| Exact simulator | [`packages/core/src/mechanics/plant-model.js`](../../packages/core/src/mechanics/plant-model.js), deterministic RNG, event timing, office endgame, camera stalls, route graphs | Correct Minus 7 cycles pass 200/200 seeds and 100/100 worst-luck sweeps. These are model results, not device clears. |
...
| Stock-device execution boundary | [`apps/device`](../../apps/device/README.md), registered profiles/adapters, and `tools/device/night-run.sh`, which drives the campaign executor (the legacy `legacy-trial.sh` runner was archived 2026-09-25, [`ARCHIVED-ROUTES.md`](../ARCHIVED-ROUTES.md)) | The package dry-run is fixture-backed; live transport composition and a full-night 10/20 clear remain unclaimed. |
| Reactive visual sensing | Static libc-free AArch64 [`screencheck`](../../packages/screencheck/src/screencheck.c), ROI/pixel/template classifiers, holdout/replay/benchmark pipeline | Cheap stock-device sensing exists and BB-left models are integrated. It is not yet a complete night-wide perception stack. |
