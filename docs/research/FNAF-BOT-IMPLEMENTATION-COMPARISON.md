...
| Stock-device execution boundary | [`apps/device`](../../apps/device/README.md), registered profiles/adapters, and the explicitly legacy [`tools/device/legacy-trial.sh`](../../tools/device/legacy-trial.sh) | The package dry-run is fixture-backed; live transport composition and a full-night 10/20 clear remain unclaimed. |
